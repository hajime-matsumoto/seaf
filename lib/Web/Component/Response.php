 ...
 * WEBレスポンス管理
 */
class Response implements Web\ComponentIF
{
    ...
    public function send ( ) {
        ...
        $body = $this->body;
        $this->clear();
        BackEnd( )->util->phpFunction->exit($body);
    }
    ...
    {
        $json = BackEnd( )->util->phpFunction->json_encode($this->toArray( ));
        $this->clear();
